...
This specification defines requirements for a targeted flashcard expansion (Phase 2) of the Junior Dev QCM revision application. This expansion focuses on filling knowledge gaps by analyzing both existing flashcards AND MCQs, then creating comprehensive flashcard coverage (25-30 new flashcards per topic). The content emphasizes foundational concepts (80% base, 20% junior) to ensure complete flashcard coverage of all topics present in the application.
...
- **Code-Query Focus**: Content emphasizing syntax, queries, commands, and practical code patterns

## Requirements

### Requirement 1: Content Volume and Distribution

**User Story:** As a junior developer, I want focused supplementary content that fills gaps in my knowledge, so that I can quickly review missing concepts without overwhelming volume.
...
3. THE Application SHALL prioritize topics with code and query focus (SQL, Git commands, syntax patterns, API usage)
...
2. THE Application SHALL distribute MCQ difficulty with 80% Base and 20% Junior
3. THE Application SHALL exclude Intermédiaire level content from this expansion
4. THE Application SHALL ensure difficulty labels match the actual complexity of questions

### Requirement 3: Content Focus and Quality

**User Story:** As a junior developer preparing for technical assessments, I want content focused on practical code patterns and queries, so that I can quickly recognize and write correct syntax.

#### Acceptance Criteria

1. THE Application SHALL prioritize SQL query patterns and syntax for database topics
2. THE Application SHALL prioritize Git commands and workflows for Git topic
3. THE Application SHALL prioritize syntax patterns and common methods for programming language topics
4. THE Application SHALL prioritize framework-specific syntax and API usage for framework topics
5. THE Application SHALL include code snippet examples in questions where relevant
6. THE Application SHALL focus on "how to write" and "what does this do" question types
7. THE Application SHALL avoid theoretical concepts already well-covered in existing content
...
5. THE Application SHALL maintain the same deck/topic names as existing content
6. THE Application SHALL set needsReview to false by default
...
1. THE Application SHALL process topics in batches of 3-4 files at a time
...
**User Story:** As a junior developer, I want expanded coverage of code-heavy and query-heavy topics first, so that I can practice the most practical skills.

#### Acceptance Criteria

1. THE Application SHALL prioritize database topics (MySQL, MongoDB) for SQL and query syntax
2. THE Application SHALL prioritize Git for command-line operations and workflows
3. THE Application SHALL prioritize JavaScript for syntax patterns and built-in methods
4. THE Application SHALL prioritize backend frameworks (PHP, Laravel, Node.js/Express) for API and routing syntax
5. THE Application SHALL prioritize React for hooks and JSX syntax patterns
6. THE Application SHALL process remaining topics based on code/query density
...
6. THE Application SHALL write MCQ explanations that are clear and educational (20-40 words)
