export const javaJeeFlashcards = [
  ...
  { id: "java-jee-35", deck: "Java/JEE", difficulty: "Base", front: "Que fait la méthode add() sur une List ?", back: "Ajoute un élément à la fin de la liste", needsReview: false },
  { id: "java-jee-36", deck: "Java/JEE", difficulty: "Base", front: "Comment obtenir la taille d'une List ?", back: "Utiliser la méthode size()", needsReview: false },
  { id: "java-jee-37", deck: "Java/JEE", difficulty: "Base", front: "Que fait la méthode get(index) sur une List ?", back: "Retourne l'élément à la position spécifiée", needsReview: false },
  { id: "java-jee-38", deck: "Java/JEE", difficulty: "Base", front: "Comment supprimer un élément d'une List ?", back: "Utiliser remove(index) ou remove(object)", needsReview: false },
  { id: "java-jee-39", deck: "Java/JEE", difficulty: "Base", front: "Que fait la méthode contains() sur une Collection ?", back: "Vérifie si la collection contient l'élément spécifié", needsReview: false },
  { id: "java-jee-40", deck: "Java/JEE", difficulty: "Base", front: "Comment vider une Collection ?", back: "Utiliser la méthode clear()", needsReview: false },
  { id: "java-jee-41", deck: "Java/JEE", difficulty: "Base", front: "Que fait la méthode put(key, value) sur une Map ?", back: "Associe la valeur à la clé dans la Map", needsReview: false },
  { id: "java-jee-42", deck: "Java/JEE", difficulty: "Base", front: "Comment récupérer une valeur dans une Map ?", back: "Utiliser get(key)", needsReview: false },
  { id: "java-jee-43", deck: "Java/JEE", difficulty: "Base", front: "Que fait la méthode length() sur un String ?", back: "Retourne le nombre de caractères dans la chaîne", needsReview: false },
  { id: "java-jee-44", deck: "Java/JEE", difficulty: "Base", front: "Comment concaténer deux String ?", back: "Utiliser + ou la méthode concat()", needsReview: false },
  { id: "java-jee-45", deck: "Java/JEE", difficulty: "Base", front: "Que fait substring(start, end) ?", back: "Extrait une sous-chaîne du début (inclus) à la fin (exclus)", needsReview: false },
  { id: "java-jee-46", deck: "Java/JEE", difficulty: "Base", front: "Comment convertir un String en minuscules ?", back: "Utiliser toLowerCase()", needsReview: false },
  { id: "java-jee-47", deck: "Java/JEE", difficulty: "Base", front: "Que fait la méthode trim() sur un String ?", back: "Supprime les espaces au début et à la fin", needsReview: false },
  { id: "java-jee-48", deck: "Java/JEE", difficulty: "Base", front: "Structure d'un try-catch en Java ?", back: "try { code } catch (Exception e) { gestion erreur }", needsReview: false },
  { id: "java-jee-49", deck: "Java/JEE", difficulty: "Base", front: "À quoi sert le bloc finally ?", back: "Code exécuté toujours, même si exception levée ou non", needsReview: false },
  { id: "java-jee-50", deck: "Java/JEE", difficulty: "Base", front: "Que signifie private sur une méthode ?", back: "Accessible uniquement dans la même classe", needsReview: false },
  { id: "java-jee-51", deck: "Java/JEE", difficulty: "Base", front: "Que signifie protected ?", back: "Accessible dans la même classe, sous-classes et même package", needsReview: false },
  { id: "java-jee-52", deck: "Java/JEE", difficulty: "Base", front: "À quoi sert le mot-clé this ?", back: "Référence l'instance courante de la classe", needsReview: false },
  { id: "java-jee-53", deck: "Java/JEE", difficulty: "Base", front: "À quoi sert le mot-clé super ?", back: "Référence la classe parent (constructeur ou méthodes)", needsReview: false },
  { id: "java-jee-54", deck: "Java/JEE", difficulty: "Base", front: "Comment créer un tableau en Java ?", back: "int[] arr = new int[taille] ou int[] arr = {1, 2, 3}", needsReview: false },
  { id: "java-jee-55", deck: "Java/JEE", difficulty: "Base", front: "Comment obtenir la longueur d'un tableau ?", back: "Utiliser la propriété length (pas de parenthèses)", needsReview: false },
  { id: "java-jee-56", deck: "Java/JEE", difficulty: "Base", front: "Qu'est-ce que l'overloading ?", back: "Plusieurs méthodes avec le même nom mais paramètres différents", needsReview: false },

  // Expansion Phase 3 - Junior (6 flashcards)
  { id: "java-jee-57", deck: "Java/JEE", difficulty: "Junior", front: "Que fait stream().filter() ?", back: "Filtre les éléments selon un prédicat (condition)", needsReview: false },
  { id: "java-jee-58", deck: "Java/JEE", difficulty: "Junior", front: "Que fait stream().map() ?", back: "Transforme chaque élément en appliquant une fonction", needsReview: false },
  { id: "java-jee-59", deck: "Java/JEE", difficulty: "Junior", front: "Que fait stream().collect(Collectors.toList()) ?", back: "Collecte les éléments du stream dans une List", needsReview: false },
  { id: "java-jee-60", deck: "Java/JEE", difficulty: "Junior", front: "Qu'est-ce qu'un générique en Java ?", back: "Paramètre de type pour créer des classes/méthodes réutilisables : List<String>", needsReview: false },
  { id: "java-jee-61", deck: "Java/JEE", difficulty: "Junior", front: "Cycle de vie d'un Servlet ?", back: "init() → service() (doGet/doPost) → destroy()", needsReview: false },
  { id: "java-jee-62", deck: "Java/JEE", difficulty: "Junior", front: "Comment gérer une session en Servlet ?", back: "HttpSession session = request.getSession()", needsReview: false },
];
