export const keywordMaps = [
  ...
  },
  {
    ...
    data: {
      ...
      rows: [
        ["Philosophy", "Utility-first (compose)", "Component-based (pre-built)", "❌"],
        ["Container", "container mx-auto px-4", ".container / .container-fluid", "⚠️"],
        ["Grid Columns", "grid-cols-{1-12}", ".col-{1-12}", "✅"],
        ...
        ["Margin", "m-{0-96} → 0-24rem", ".m-{0-5} → 0-3rem", "⚠️"],
        ["Margin Directional", "mt-4 mb-2 mx-auto my-3", ".mt-3 .mb-2 .mx-auto .my-3", "✅"],
        ["Padding", "p-{0-96} → 0-24rem", ".p-{0-5} → 0-3rem", "⚠️"],
        ["Padding Directional", "pt-4 px-6 py-2", ".pt-3 .px-4 .py-2", "✅"],
        ["Background Colors", "bg-{color}-{50-900}", ".bg-{primary|secondary|success|danger|warning|info}", "⚠️"],
        ["Text Colors", "text-{color}-{50-900}", ".text-{primary|secondary|success|danger|muted|white}", "⚠️"],
        ["Font Size", "text-{xs|sm|base|lg|xl|2xl|3xl...9xl}", ".h{1-6} or custom", "⚠️"],
        ["Font Weight", "font-{thin|light|normal|medium|semibold|bold|black}", ".fw-{light|normal|bold}", "⚠️"],
        ["Text Alignment", "text-{left|center|right|justify}", ".text-{start|center|end}", "✅"],
        ["Buttons", "Compose: bg-blue-500 hover:bg-blue-700 px-4 py-2 rounded", ".btn .btn-{primary|secondary|success|danger}", "❌"],
        ["Button Outline", "Compose: border border-blue-500 text-blue-500", ".btn-outline-{primary|secondary|success|danger}", "❌"],
        ["Button Sizes", "Compose: px-2 py-1 text-sm / px-6 py-3 text-lg", ".btn-sm / .btn-lg", "❌"],
        ...
        ["Width", "w-{0-full} w-1/2 w-64", ".w-{25|50|75|100}", "⚠️"],
        ...
        ["Spacing Scale", "0.25rem steps: 0→96 = 0→24rem", "0.25rem steps: 0→5 = 0→3rem", "⚠️"],
        ["Images", "Compose: w-full h-auto object-cover rounded", ".img-fluid .rounded .img-thumbnail", "⚠️"],
        ["Float", "float-{left|right|none}", ".float-{start|end}", "✅"],
        ["Form Inputs", "Compose: border rounded px-3 py-2 focus:ring", ".form-control .form-control-{lg|sm}", "❌"],
        ["Form Select", "Compose: border rounded px-3 py-2", ".form-select .form-select-{lg|sm}", "❌"],
        ["Checkboxes/Radio", "Custom styling required", ".form-check .form-check-input .form-switch", "❌"],
        ...
        ["Opacity", "opacity-{0-100}", ".opacity-{0|25|50|75|100}", "⚠️"],
        ["Position", "absolute relative fixed sticky static", ".position-{static|relative|absolute|fixed|sticky}", "✅"],
        ["Z-index", "z-{0|10|20|30|40|50}", "No utility (custom CSS)", "❌"],
        ["Overflow", "overflow-{auto|hidden|scroll|visible}", ".overflow-{auto|hidden|scroll|visible}", "✅"],
        ["Hover States", "hover:bg-blue-700 hover:text-white", "No utility (custom CSS)", "❌"],
        ["Focus States", "focus:ring focus:outline-none focus:border-blue-500", "No utility (custom CSS)", "❌"],
